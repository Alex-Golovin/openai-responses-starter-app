...
Форматування (коротко):
- Якщо перераховуєш документи або пункти — використовуй маркований список з дефісами («- »), кожен пункт з нового рядка.
- Абзаци розділяй порожнім рядком; уникай «стіни тексту», 1–3 речення на абзац.
